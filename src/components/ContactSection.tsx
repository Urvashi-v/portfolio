            ...
            <div className="p-8 rounded-2xl bg-card border border-border shadow-card">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:urvashi@example.com" className="text-muted-foreground hover:text-primary transition-colors">
                      urvashiverma506@gmail.com
                    </a>
                  </div>
                </div>
              ...
              <div className="mt-8 pt-8 border-t border-border">
                ...
                <div className="flex gap-3">
                  <motion.a
                    href="https://www.linkedin.com/in/urvashi-verma-894236283?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                  ...
                  <motion.a
                    href="https://github.com/Urvashi-v"
                    whileHover={{ scale: 1.1, y: -2 }}
                    whileTap={{ scale: 0.95 }}
                    className="w-12 h-12 rounded-xl bg-muted flex items-center justify-center text-muted-foreground hover:text-primary hover:bg-primary/10 transition-colors"
                  >
                  ...
                  <motion.a
                    href="mailto:urvashiverma506@gmail.com"
                    whileHover={{ scale: 1.1, y: -2 }}
                    whileTap={{ scale: 0.95 }}
                    className="w-12 h-12 rounded-xl bg-muted flex items-center justify-center text-muted-foreground hover:text-primary hover:bg-primary/10 transition-colors"
                  >
            ...
            <form onSubmit={handleSubmit} className="p-8 rounded-2xl bg-card border border-border shadow-card space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  className="w-full px-4 py-3 rounded-xl bg-muted border border-border focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all resize-none text-foreground placeholder:text-muted-foreground"
